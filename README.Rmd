...
```
To get an overview of all available photographs for a given area, plot_photos(x) generates a bar chart summarizing the number of images by year and color type
